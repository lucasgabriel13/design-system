...
import { ComponentProps, ElementType, ComponentPropsWithRef, ReactNode } from 'react';
...
type TextInputProps = ComponentPropsWithRef<typeof Input> & {
    prefix?: string;
};
...
declare const Toast: ({ title, subtitle, open, onClose }: ToastProps) => react_jsx_runtime.JSX.Element;
...
declare const theme: string & {
    ...
    colors: {
        ...
        ignite200: _stitches_react_types_theme.Token<"ignite200", string, "colors", "">;
...
declare const createTheme: <Argument0 extends string | ({
    colors?: {
        ...
        ignite200?: string | number | boolean | undefined;
